...
mysql_select_db($database_localhost, $localhost);
$query_Recordset2 = "SELECT class_record.`datetime`, class_record.weektime FROM class_record";
...
<div class="div-head">
<a href="fillin.php">	<button class="button-fillin" onclick="location.href='fillin.php'">填寫</button></a>
<a href="up.php">    <button class="button-fillup">填寫紀錄</button></a>
</div>
<div class="div-head">
	<div class="remind">
    	<p>系統提示</p>
