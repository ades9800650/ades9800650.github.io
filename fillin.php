...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO class_record (`datetime`, weektime, classname, `level`, fillinname, usertotal, int01, int02, int03, int04, int05, course1, course2, course3, course4, course5, teacher1, teacher2, teacher3, teacher4, teacher5, class1, class2, class3, class4, class5, record1, record2, record3, record4, record5, homework1, homework2, homework3, homework4, homework5, remarks1, remarks2, remarks3, remarks4, remarks5, fillintime) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['schedule1'], "text"),
...
mysql_select_db($database_localhost, $localhost);
$query_Recordset4 = "SELECT `user`.`class`, `user`.`level`, `user`.user_ID, `user`.user_Password, `user`.user_Name FROM `user` WHERE `user`.`class` = '資訊' AND `user`.`level`='三'";
...
<div class="fillin-title">
  ...
  <div class="w80-mc">
    ...
    <table width="80%" border="1" align="center" cellpadding="10" bordercolor="#FFFFFF">
        ...
        <tr>
		<?php do { ?>
          <td valign="middle"><input required="required" name="fruit" type="checkbox" id="user_name-1-2-3" value="<?php echo $row_username13['user_Name']; ?>"/>
    ...
    <p style="display:none;">
      ...
      <input type="text" name="user_total" id="user_total" required="required"/>
    </p>
  </div>
  ...
  <div class="courseName" id="courseName1">
    <p class="level">課程名稱: <?php echo $row_course_name['course_name']; ?></p>
  ...
  <div class="teacher">
    <p class="level">任課老師:<?php echo $row_course_name['course_teacher']; ?></p>
  ...
  <div class="w100">
    ...
    <div class="fillin-content-1">
      ...
      <select name="class1" id="progressClass1" required>
        <option selected="selected">教學進度</option>
        <option>班會</option>
        <option>週會</option>
        <option>代課</option>
        <option>調課</option>
    ...
    <div class="w100">
      <p>備註:</p>
      <textarea name="ex1" style="width:100%;" id="ex1"></textarea>
    </div>
  </div>
  ...
  <div class="courseName">
    <p class="level">課程名稱：<?php echo $row_course_name2['course_name']; ?></p>
  ...
  <div class="teacher">
    <p class="level">任課老師:<?php echo $row_course_name2['course_teacher']; ?></p>
  ...
  <div class="w100">
    <p>備註:</p>
    <textarea name="ex2" style="width:100%;" id="ex2"></textarea>
  </div>
  <div style="text-align:right;margin:2%;">
  ...
  <div class="courseName">
    <p class="level">課程名稱:<?php echo $row_course_name3['course_name']; ?></p>
  ...
  <div class="teacher">
    <p class="level">任課老師:<?php echo $row_course_name3['course_teacher']; ?></p>
  ...
  <div class="w100">
    <p>備註:</p>
    <textarea name="ex3" style="width:100%;" id="ex3"></textarea>
  </div>
  <div style="text-align:right;margin:2%;">
  ...
  <div class="courseName">
    <p class="level">課程名稱:<?php echo $row_course_name4['course_name']; ?></p>
  ...
  <div class="teacher">
    <p class="level">任課老師:<?php echo $row_course_name4['course_teacher']; ?></p>
  ...
  <div class="w100">
    <p>備註:</p>
    <textarea name="ex4" style="width:100%;" id="ex4"></textarea>
  </div>
  <div style="text-align:right;margin:2%;">
  ...
  <div class="courseName">
    <p class="level">課程名稱:<?php echo $row_course_name5['course_name']; ?></p>
  ...
  <div class="teacher">
    <p class="level">任課老師:<?php echo $row_course_name5['course_teacher']; ?></p>
